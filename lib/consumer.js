...
(function() {
  var BSON, CONNECTION_END_WAIT, Consumer, Delay, LinearQuantizer, Pow2Quantizer, RECONNECT_INTERVAL, REQUEST_ENABLE_INTERVAL, REQUEST_SAMPLE_INTERVAL, Timer, amqp, colors, exchanges, ref, rx, uuid,
    slice = [].slice;
