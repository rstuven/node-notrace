(function() {
  var BSON, CONNECTION_END_WAIT, Consumer, Delay, Quantizer, RECONNECT_INTERVAL, REQUEST_ENABLE_INTERVAL, REQUEST_SAMPLE_INTERVAL, Timer, amqp, colors, exchanges, rx, uuid,
  ...
  Quantizer = require('./quantizer').Quantizer;

  exchanges = require('./exchanges');

  rx.Observable.prototype.quantize = function() {
    return this.aggregate(new Quantizer, function(q, v) {
      q.add(v);
      return q;
    });
  };
  ...
  */
  ...
  exports.Consumer = Consumer = (function() {
    ...
    Consumer.prototype.start = function(config, callback) {
      ...
      if (typeof callback === 'object') {
        this.start(config, function(subject) {
          return Consumer.generateObservable(callback, subject).subscribe(callback.callback);
        });
        return;
      }
    ...
    */
    ...
    Consumer.generateObservable = function(config, subject) {
      ...
      return func.call({}, subject, calculate);
    };

    calculate = function(type, nFn, dFn, sampleOld, sampleNew) {
