...
(function() {
  var BSON, CONNECTION_END_WAIT, Consumer, Delay, LinearQuantizer, Pow2Quantizer, RECONNECT_INTERVAL, REQUEST_ENABLE_INTERVAL, REQUEST_SAMPLE_INTERVAL, Timer, amqp, chalk, exchanges, ref, rx, uuid,
    slice = [].slice;
  ...
  ref = require('./quantizer'), Pow2Quantizer = ref.Pow2Quantizer, LinearQuantizer = ref.LinearQuantizer;
  ...
  exports.Consumer = Consumer = (function() {
    ...
    Consumer.prototype.sample = function(probeKey, callback) {
      return this.start(probeKey, (function(_this) {
    ...
    Consumer.prototype.start = function(config, callback) {
      ...
      this.sampleInterval = (ref1 = config != null ? config.sampleInterval : void 0) != null ? ref1 : REQUEST_SAMPLE_INTERVAL;
    ...
    Consumer.prototype.request = function() {
      var args, e, message, probeKey, request;
      probeKey = arguments[0], request = arguments[1], args = 3 <= arguments.length ? slice.call(arguments, 2) : [];
    ...
    Consumer.prototype.connect = function() {
      ...
      host = (ref1 = this.config.host) != null ? ref1 : 'localhost';
      ...
      return this.connection.on('ready', (function(_this) {
        return function() {
          return _this.open();
        };
      })(this));
    ...
    Consumer.prototype.open = function() {
      return exchanges.requests(this.connection, (function(_this) {
            ...
            return _this.connection.queue('', function(queue) {
              ...
              queue.subscribe({
                ...
                if (_this.subject != null) {
                  return _this.subject.onNext(message);
                }
              });
    ...
    Consumer.prototype.disconnect = function(immediate) {
      ...
      if (immediate) {
        ...
        return this.connectionEndDelay.start(CONNECTION_END_WAIT, (function(_this) {
          return function() {
            if (_this.connection != null) {
    ...
    generateObservable = function(config, subject) {
      ...
      globalProps = (function() {
        ...
        for (globalProp in global) {
          if (globalProp !== 'console') {
            results.push(globalProp);
          }
        }
        return results;
      })();
