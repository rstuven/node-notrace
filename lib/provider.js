  ...
  */
  ...
  exports.Provider = Provider = (function(_super) {
    ...
    */
    ...
    Provider.prototype.instrumentalize = function(obj, options) {
      ...
      if (typeof obj === 'function') {
        if (obj.__notrace_instrumentalized) return obj;
        wrapper = function() {
        ...
        this.markAsInstrumentalized(wrapper);
        return wrapper;
      }
      if (obj.__notrace_instrumentalized) return;
      baseName = options.name != null ? options.name + '.' : '';
      Object.keys(obj).forEach(function(key) {
        var prop;
        prop = obj[key];
        if (typeof prop === 'function') {
          return obj[key] = _this.instrumentalize(prop, {
            name: baseName + key
          });
        } else if (typeof prop === 'object') {
          return _this.instrumentalize(prop);
        }
      });
      return this.markAsInstrumentalized(obj);
    };

    Provider.prototype.markAsInstrumentalized = function(obj) {
      return Object.defineProperty(obj, '__notrace_instrumentalized', {
        value: true,
        enumerable: false,
        writable: false
      });
